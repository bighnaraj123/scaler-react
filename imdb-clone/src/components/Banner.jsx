...
const Banner = () => {
  ...
  // const TMDB_TRENDING_MOVIE_BASE_URL = import.meta.env
   // .VITE_TRENDING_MOVIES_BASE_URL;
    ...
    const  TMDB_API_KEY="0fa9d94b072b5c497f3a9720acb86bc2";
     const TMDB_TRENDING_MOVIE_BASE_URL="https://api.themoviedb.org/3/trending/movie/day";
      const VITE_GEMINI_API_KEY="AIzaSyDO0EAEQz6yAoWwi8MpKuuZJ0Ay8MrzarI";
  useEffect(() => {
    try {
      setLoader(true);
